<template>
  <div class="profile-container">
    ...
    <p class="about-content">
      ...
      <br>Please try to complete your information as fully as possible. It will help calculate the health indicators of
      your body.
    </p>
    ...
    <div class="about-section" v-if="activeTab === 'overview'">
      ...
      <div v-if="hasMissingInfo" class="missing-info-tip">
        <el-alert title="Please complete your personal information." type="warning" show-icon effect="light" />
      </div>

      <h2 class="section-title">Profile</h2>
      <!-- 手动实现的表格区域 -->
      <div class="custom-table">
        <div class="table-row" v-for="(value, key) in userInfo" :key="key">
